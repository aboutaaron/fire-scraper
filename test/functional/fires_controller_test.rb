...
class FiresControllerTest < ActionController::TestCase
  ...
  test "should create fire" do
    assert_difference('Fire.count') do
      post :create, fire: { acerage: @fire.acerage, county_id: @fire.county_id, date: @fire.date, name: @fire.name }
    end
  ...
  test "should update fire" do
    put :update, id: @fire, fire: { acerage: @fire.acerage, county_id: @fire.county_id, date: @fire.date, name: @fire.name }
    assert_redirected_to fire_path(assigns(:fire))
  end
